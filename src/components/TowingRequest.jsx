...
import { 
  ...
  Upload, Zap, ShieldCheck, ArrowLeft, CheckCircle2, Phone 
} from 'lucide-react';
            ...
            <div className="space-y-4">
              <div>
                ...
                <select 
                  ...
                  className="w-full bg-white border border-[#c2c6d6] rounded-xl px-3 py-2.5 text-xs text-[#0b1c30] focus:ring-2 focus:ring-[#0058be] focus:outline-none"
                >
            ...
            <div>
              ...
              <div 
                ...
                className={`border-2 border-dashed rounded-xl p-4 text-center cursor-pointer transition-colors ${
                  photosUploaded ? 'border-[#0058be] bg-[#eff4ff]' : 'border-[#c2c6d6] hover:bg-[#f8f9ff]'
                }`}
              >
                <Upload className="w-6 h-6 mx-auto text-[#727785] mb-1" />
                <span className="text-xs font-semibold text-[#0b1c30] block">
                  {photosUploaded ? '1 Photo Attached (Front bumper)' : 'Tap to upload scene photos'}
                </span>
